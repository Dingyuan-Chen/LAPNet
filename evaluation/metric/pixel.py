...
from evaluation.metric.confusion_matrix import ConfusionMatrix
from evaluation.metric.logger import get_console_file_logger
...
class PixelMetric(ConfusionMatrix):
    ...
    def cohen_kappa_score(cm_th):
        ...
        k = np.sum(w_mat * cm_th) / np.sum(w_mat * expected)
        return 1. - k
    ...
    def summary_all(self, dec=5):
        ...
        # return tb
        return {'mIoU': miou, 'F1': mF1, 'Precision': mprec, 'Recall': mrecall, 'OA': overall_accuracy, 'Kappa': kappa}